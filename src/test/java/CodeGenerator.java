...
public class CodeGenerator {
    //JDBC配置，请修改为你项目的实际配置
    private static final String JDBC_URL = "jdbc:mysql://116.62.134.242:3306/springboot?characterEncoding=utf8&useSSL=false";
    private static final String JDBC_USERNAME = "springboot";
    private static final String JDBC_PASSWORD = "springboot";
    ...
    private static final String AUTHOR = "CuiCan";//@author
